...
class Test
{
  ...
  //                              //  false. Se for, nao faz box e coloca null em 'oV'
        ...
        //
		V? nv = new V();
		V v = (V) nv; // Invoca propriedade Value
		v.val = 10;
        object o1 = nv;
		object o = v;
        // Ver IL
  ...
  //      V unboxNullableV = (V)o1;
		//Console.WriteLine(unboxNullableV.val);
	
  //      V? unboxNullableV1 = (V?)o1;
		//Console.WriteLine(unboxNullableV1.Value.val);
